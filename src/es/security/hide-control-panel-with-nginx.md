...
2.  Reinicie Nginx:
    ...
    ```
3.  Verifique el DNS: Asegúrese de que los tres dominios (`pay.some-domain.com`, `integration.some-domain.com`, `panel.some-domain.com`) apunten a la dirección IP de su servidor.
